...
const BlogPost: React.FC = () => {
  ...
  const renderPostContent = (content: string) => ({ __html: content });
      ...
      <div className={styles.errorContainer}>
        <div className={styles.errorContent}>
          ...
          <p className={styles.errorHint}>
            Please ensure the API endpoint is accessible and the X-Tenant header is valid.
          </p>
    ...
    <div className={styles.container}>
            ...
            <div className={styles.cardContent}>
              ...
              {post.tags && post.tags.length > 0 && (
                <div className={styles.cardTags}>
                  ...
                  {post.tags.length > 4 && <span className={styles.moreTags}>+{post.tags.length - 4} more</span>}
                </div>
              )}
            ...
            <div className={styles.postDetailHeader}>
              ...
              {post.featuredImage && (
                <div className={styles.postDetailImageContainer}>
                  <img src={post.featuredImage} alt={post.featuredImageAlt || post.title} className={styles.postDetailImage} />
                </div>
              )}
              <div className={styles.postDetailAuthor}>
                {post.authorAvatar && (
                  <img src={post.authorAvatar} alt={post.author} className={styles.postDetailAuthorAvatar} />
                )}
                <div className={styles.postDetailAuthorInfo}>
                  <h3 className={styles.postDetailAuthorName}>{post.author}</h3>
                  {post.authorBio && <p className={styles.postDetailAuthorBio}>{post.authorBio}</p>}
                </div>
              </div>
            </div>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerBottom}>
          <p className={styles.footerText}>© {new Date().getFullYear()} Artemis Blog. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
